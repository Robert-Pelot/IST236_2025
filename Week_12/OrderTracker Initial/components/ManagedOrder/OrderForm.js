...
function OrderForm(props) {
  const [inputs, setInputs] = useState({
    total: {
      value: props.defaultValue ? props.defaultValues.total.toString() : "",
      isValid: true,
    },
    date: {
    ...
    description: {
      value: props.defaultValue ? props.defaultValues.description : "",
      isValid: true,
    },
  });
  ...
  function submitHandler() {
    ...
    if (!totalIsValid || !dateIsValid || !descriptionIsValid) {
      setInputs((currentInputs) => {
        return {
          total: { value: currentInputs.total.value, inValid: totalIsValid },
